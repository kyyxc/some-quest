...
const Sidebar = () => {
    ...
    const totalMeetings = props.totalMeetings;
        ...
        >
            ...
            <div className="mt-2 mb-6 flex items-center justify-between">
                ...
                <Button
                    ...
                    className="ms-1 flex h-10 w-10 items-center justify-center hover:bg-blue-100"
                >
                ...
                {navItems.map((item) => {
                    ...
                    return (
                        <Link
                            key={item.to}
                            href={item.to}
                            className={`flex items-center justify-between rounded-xs p-3 transition-colors ${
                        ...
                        >
                            ...
                            {!collapsed && item.badge !== undefined && <Badge className="bg-gray-200 font-semibold text-black">{item.badge}</Badge>}
                        </Link>
                    );
                })}
            </nav>
            ...
            <div className="mt-auto border-t border-gray-300 pt-4">
                <Button
                    variant="default"
                    className={`w-full gap-3 px-3 py-7 text-sm text-gray-800 hover:bg-blue-100 hover:text-black ${
                ...
                >
                    ...
                    {!collapsed && (
                        <div className="flex flex-col items-start text-left leading-tight">
                            ...
                            <span className="text-xs break-all text-muted-foreground">{user?.email || 'No Email'}</span>
                        </div>
                    )}
                </Button>
