                        ...
                        >
                            ...
                            {!collapsed &&
                                item.badge !== undefined && (
                                    <Badge className="bg-gray-200 font-semibold text-black">
                                        {item.badge}
                                    </Badge>
                                )}
                        </Link>
